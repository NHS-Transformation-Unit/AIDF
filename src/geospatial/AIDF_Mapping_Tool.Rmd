...
OHID_L_shared_df <- SharedData$new(OHID_shp_dates$data, group = OHID_L_shared$groupName)
...
bscols(widths = c(10, 1),
       list(filter_slider(id = "Net_Implementation_End", label = "Implementation End Date: ",
                          sharedData = OHID_L_shared_df, column = ~Net_Implementation_End),
            imp_mapping))
